...
class CardPaymentPresenterTest {
    ...
    fun setUp() {
        ...
        sut = CardPaymentPresenter(mockView, mockInteractions, mockPaymentApiInteractor, mockStringResources)
    ...
    private fun initPresenterForPayment(state: String) {
        ...
        whenever(mockPaymentApiInteractor.getOrder(
            ...
            it.getArgument<((String, String, Set<CardType>, OrderAmount, String) -> Unit)>(2)(fixtOrderReference, fixtPaymentUrl, setOf(Visa, MasterCard, AmericanExpress), OrderAmount(2000.00, "AED"), "")
        }
